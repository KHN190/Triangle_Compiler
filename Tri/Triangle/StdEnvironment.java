...
public final class StdEnvironment {
  ...
  public static TypeDenoter
    booleanType, charType, integerType, anyType, errorType, stringType;
  ...
  public static BinaryOperatorDeclaration
    andDecl, orDecl,
    addDecl, subtractDecl, multiplyDecl, divideDecl, moduloDecl, lexicoIncDecl, lexicoDecDecl,
    equalDecl, unequalDecl, lessDecl, notlessDecl, greaterDecl, notgreaterDecl;

  public static ProcDeclaration
    getDecl, putDecl, putsDecl, getintDecl, putintDecl, geteolDecl, puteolDecl;

  public static FuncDeclaration
    chrDecl, ordDecl, eolDecl, eofDecl, haltDecl;
